...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_04c1078a_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(146);
var disposed = false
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_asyncToGenerator__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_asyncToGenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_asyncToGenerator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_allApi__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_index__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_RdWXBizDataCrypt__ = __webpack_require__(142);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    CoinClick: function CoinClick(v, index) {
      ...
      setTimeout(function () {
        _this2.CoinList.map(function (v) {
          ...
          _this2.isAni = false;
          _this2.CoinList[index].showType = false;
        });
      }, 500);
    },
    ...
    RandomMoneyMake: function RandomMoneyMake(n, obj) {
      var lengths = parseInt(n);
      this.CoinList = [];
      for (var i = 0; i < lengths; i++) {
        ...
        v.translateY = 0;
        v.opacity = 1;
        v.right = Object(__WEBPACK_IMPORTED_MODULE_3__utils_index__["b" /* RandomNum */])(10, (this.getObj.width - this.coin.width) / 2);
        v.top = Object(__WEBPACK_IMPORTED_MODULE_3__utils_index__["b" /* RandomNum */])(10, (this.getObj.height - this.coin.height) / 2);
        v.ImgUrl = '../../static/imgs/coin' + Object(__WEBPACK_IMPORTED_MODULE_3__utils_index__["b" /* RandomNum */])(2, 6) + '.png';
        v.showType = true;
      ...
      wx.cloud.callFunction({
        ...
        wx.getWeRunData({
          ...
          success: function success(datas) {
            var encryptedData = datas.encryptedData;
            var iv = datas.iv;
            var pc = new __WEBPACK_IMPORTED_MODULE_4__utils_RdWXBizDataCrypt__["a" /* default */](that.appid, res.result.home.session_key);
            var runData = pc.decryptData(encryptedData, iv) || [];
            //今日步数
            var currentData = runData.stepInfoList[runData.stepInfoList.length - 1];
            ...
            var run = db.collection('runDatas');
            run.where({
              openid: that.openid
              ...
              if (!response.data[0]) {
                ...
                console.log(Object(__WEBPACK_IMPORTED_MODULE_3__utils_index__["c" /* formatDate */])(that.ExpectData.timestamp * 1000, 'yyyy-MM-dd'), response.data[0].items.date);
                if (Object(__WEBPACK_IMPORTED_MODULE_3__utils_index__["c" /* formatDate */])(that.ExpectData.timestamp * 1000, 'yyyy-MM-dd') != response.data[0].items.date) {
                ...
                var bites = Math.ceil(that.ExpectData.TodayWalk / 1000) - response.data[0].items.currency;
    ...
    sumbmitRunData: function sumbmitRunData(openid, datas, type) {
      var _this3 = this;
        ...
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                datas['date'] = Object(__WEBPACK_IMPORTED_MODULE_3__utils_index__["c" /* formatDate */])(datas.timestamp * 1000, 'yyyy-MM-dd');
                list = {
                  openid: openid,
                  items: datas
                };
    ...
    resetCurrenty: function resetCurrenty(datas) {
      var _this4 = this;
 ...
 */
// 引入CryptoJS
var Crypto = __webpack_require__(143).Crypto;
...
/* harmony default export */ __webpack_exports__["a"] = (RdWXBizDataCrypt);
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "user-info bg-white gap"
  }, [_c('div', {
    ...
    staticClass: "todayRunData"
  }, [_c('view', {
    staticClass: "todayData"
  }, [_c('text', [_vm._v("今日步数")]), _vm._v(" "), _c('view', {
    staticClass: "todaywalk"
  }, [_vm._v(_vm._s(_vm.ExpectData.TodayWalk))])])]), _vm._v(" "), _c('view', {
    staticClass: "recordCont",
    style: ({
      'animation-name': _vm.isAni ? 'mymoves' : ''
    })
  }, [_c('view', {
    staticClass: "collect"
  }, [_c('view', {
    staticClass: "coinRecord"
  }, [_vm._m(1), _vm._v(" "), _c('text', {
    staticClass: "moneyCount"
  }, [_vm._v(_vm._s(_vm.ExpectData.total))])])])]), _vm._v(" "), _c('div', {
    staticClass: "coin-bg",
    style: ({
      'animation-name': _vm.ShopShakeType ? 'mymoves' : ''
    })
...
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "icon-titles text-orange"
  }), _vm._v(" 越运动越幸运\n    ")])])
  ...
  return _c('view', {
    ...
    attrs: {
      "src": "../../static/imgs/coinRecord.png"
    }
  }), _vm._v(" "), _c('text', {
    staticClass: "record"
  }, [_vm._v("股运")])])
...
(function () {
	...
	var C = typeof window === 'undefined' ? __webpack_require__(0).Crypto : window.Crypto;
